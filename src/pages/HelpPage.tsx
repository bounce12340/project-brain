...
const sections = [
  ...
  ["QA 與法規", [["效期登記簿", "QA 專案的 QA 分頁可新增證照與系統效期，並依剩餘天數顯示警示。"], ["CCR", "建立變更管制後依合法狀態逐步流轉；每一步保留歷程，效期確認會建立待辦。"], ["法規動態", "全員可在導覽列查閱並篩選；RA/PV 正職成員與管理員可新增、編輯、刪除。"], ["法規 AI 匯入", "1. 點法規動態的 AI 匯入。2. 貼文字或上傳 10 MB 內的 .txt／含文字層 .pdf。3. 編輯預覽並排除不要的列。4. 確認匯入；撞鍵資料會略過，原始檔可從條目下載。掃描 PDF 請先改貼文字。"]]],
