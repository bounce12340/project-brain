...
export function DashboardPage() {
  ...
  const cards = [["進行中專案", data.kpis.active_projects, "text-psi"], ["逾期里程碑", data.kpis.overdue_milestones, "text-danger"], ["今日待辦", data.kpis.today_todos, "text-warn"], ["本週更新", data.kpis.week_updates, "text-ok"], [`${data.v6.quarter} KR`, `${data.v6.key_results.completed}/${data.v6.key_results.total}`, "text-gold-bright"]] as const;
