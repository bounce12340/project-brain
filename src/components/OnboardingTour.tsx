...
export const TOUR_DEFINITIONS: Record<TourName, readonly TourStep[]> = {
  project: [
    ...
    { selector: "[data-tour='project-milestones']", path: "project:overview", text: { zh: "時間流把未來里程碑與已發生的事排在一起。", en: "The timeline puts upcoming milestones and past events in one list." } },
