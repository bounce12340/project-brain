...
**正式站**：<https://projects.uic-ai.com>｜**版本**：v11｜**測試**：192/192 ✅｜**平台**：Cloudflare Workers
...
新資料一律是 `TFDA 草稿`，站內通知審核者並併入每日 Email digest。具管理權者點「待審核 N」後可展開全文重點、編輯（仍維持草稿）、逐則核准／刪除，或確認後全部核准；其他 member 與所有 intern 在核准前完全看不到。核准後才進入一般 published 清單。操作與驗收時不可代替業務人員核准或刪除真實 TFDA 草稿。
