...
**正式站**：<https://projects.uic-ai.com>｜**版本**：v10｜**測試**：173/173 ✅｜**平台**：Cloudflare Workers
...
- **法規動態**：2018 年起 600+ 筆 TFDA 法規知識庫，依公告日期排序並支援產品線／類別／關鍵字篩選；**AI 匯入**——貼公告文字或合併上傳多個檔案，自動解析成結構化條目與前後對照摘要
